...
export default function UsersPage() {
  return (
    <div className="users-page relative flex min-h-screen overflow-hidden bg-black">
      {/* Animated Background */}
      <div className="users-background pointer-events-none absolute inset-0">
      ...
      <div className="relative z-10 min-w-0 flex-1">
        ...
        <main className="relative min-h-screen bg-transparent px-4 pb-6 pt-24 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 rounded-2xl border border-purple-300/20 bg-purple-500/5 p-3 shadow-[0_0_30px_rgba(139,92,246,0.08)] backdrop-blur-md transition-colors duration-300 hover:bg-purple-500/10 sm:p-5">
            <UserTable />
          </div>
        </main>
      </div>
